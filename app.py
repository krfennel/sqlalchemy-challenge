...
def welcome():
    ...
    return(
        ...
        f"<br/>"
        f"Api to return the precipitation values.<br/>"
        f"/api/v1.0/precipitation<br/>"
        f"________________________________________________<br/>"
        f"<br/>"
        f"Api for the list of stations.<br/>"
        ...
        f"/api/v1.0/tobs<br/>"
        f"_______________________________________________________________________________<br/>"
        f"<br/>"
...
def start():
    return(f"Enter a date beween 2010-01-01 to 2017-08-23 in place of start_date to obtain the Minimum, Average and Maximum Temperature values")
...
def value(start_date):
    ...
    if start_date > last_date or start_date < first_date:
        return jsonify({"error":f"Start date is out of range, enter a date between 2010-01-01 to 2017-08-23"}),404 
...
def end():
    return(
        ...
        f"In place of end_date enter any date between 2010-01-01 to 2017-08-23 until which you want to calculate the  Minimum, Average and Maximum temperature values"
    )
...
def value_2(start_date,end_date):
    ...
    if start_date > last_date or start_date < first_date:
        return jsonify({"error":f"Start Date entered is out of range, enter a date between 2010-01-01 to 2017-08-23"}),404 

    if end_date > last_date or end_date < start_date:
        return jsonify({"error":f"End Date entered is out of range, enter a date between 2010-01-01 to 2017-08-23 higher than Start_date"}),404 
